...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default=os.path.join(data_path,"train.tsv"),help='Path to the train set.')
    parser.add_argument('--dev_path', type=str, default=os.path.join(data_path,"dev.tsv"),help='Path to the dev set.')
    parser.add_argument('--test_path', type=str, default=os.path.join(data_path,"test.tsv"),help='Path to the test set.')
    parser.add_argument('--word_vec_path', type=str, default=os.path.join(data_path,"wordvec.txt"),help='Path the to pre-trained word vector model.')
    parser.add_argument('--model_dir', type=str, default="../result",help='Directory to save model files.')
    ...
    parser.add_argument('--isLower', default=True, help='With character-composed embeddings.', action='store_true')
    parser.add_argument('--config_path', type=str, help='Configuration file.')
    parser.add_argument('--use_cudnn', default=False,help='Configuration file.')
    parser.add_argument('--grad_clipper', type=float, default=10.0,  help='Configuration file.')
    parser.add_argument('--with_moving_average', default=False, help='Configuration file.')
